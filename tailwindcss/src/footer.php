...
<footer class="bg-gray-800 text-white py-8">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
                <h4 class="text-lg font-bold mb-4">Simple AI</h4>
                <ul class="space-y-2">
                  <li><a href="#" class="hover:text-gray-300">Join Referral Program</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="hover:text-gray-300">support@simpleai.com</a></li>
        ...
        <div class="text-center mt-8">
            <p>© 2024 Simple - AI Enablement Training, Coaching, and Online Certification</p>
        </div>
    </div>
</footer>
</body>
