...
?>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <h2 class="text-2xl font-bold mb-2">1. Fees & Payments Policy</h2>
        ...
        <ul class="list-disc list-inside mb-4 px-10">
            <li>Lifetime Consultants: Lifetime consultant subscriptions provide an individual customer continued access to the Simple Consultant program and to all current and future programs issued by Readitfor.me, Simple, or any other Readitfor.me brand.</li>
        </ul>
        ...
        <p class="mb-4 text-lg">
          1.6 Refund Policy. We provide a full no-questions-asked refund within seventy-two (72) hours of first signing-up with Readitfor.me LLC and its subsidiary products. To request a refund for these products, simply send us an email to support@readitfor.me within seventy-two (72) hours of your sign-up letting us know that you are canceling your plan. After that, all payments are nonrefundable and there are no refunds or credits for partially used subscription periods. As mentioned above, following any cancellation, you will continue to have access to the Product through the end of your current term. We reserve the right to refuse refunds to anyone who abuses this Refund Policy.
        </p>
        ...
        <p class="mb-4 text-lg">
          3.1 Usage of Course Materials: The course materials provided are exclusively for educational purposes. Any manufacturing, sharing, repurposing, or distribution of these materials without our express written consent is prohibited. Such consent is granted through a reseller license as part of the Simple Consultant program for use exclusively by Simple Consultants with an active subscription and only as prescribed. Unless a specific reseller license has been procured for a particular piece of content or material, you are not authorized to repurpose, sell, or distribute that material.
        </p>

        <p class="mb-4 text-lg">
          3.2 Platform Content Distribution: If you have procured our platform with the intent to sell and distribute you content, you may only distribute content that you have either produced yourself or for which you have obtained explicit distribution rights through the Simple Consultant program. Our academy and course materials are intended solely for educational use. Unauthorized sale, repurposing, or distribution of this content is strictly forbidden. You may not create a competing AI platform, AI related certification program, consultancy or agency.
        </p>

        <p class="mb-4 text-lg">
          3.3 AI Protocols and Tools Usage: Our AI protocols and tools, including but not limited to Readitfor.me and Simple protocols, training, and tools, are designed for individual usage. You are permitted to utilize any protocols, training and tools your organization has subscribed to for tasks within your organization. You may not host our tools or similar tools inspired by our tools and models on your own platform for customer facing, consulting or external use. Any resale, reverse engineering, consulting with, distribution, or repurposing of these protocols, training and tools is expressly prohibited.
        </p>
        ...
        <h2 class="text-2xl font-bold mb-2">
          5.0 Contractor and Commission
        </h2>

        <p class="mb-4 text-lg">
          5.1 Only approved contractors are authorized to sell simple subscriptions under the then-current commission structure provided by Simple. Simple reserves the right to modify the commission structure and incentives at any time, unless explicitly agreed to as a part of a consultant relationship. Affiliates may request the current structure at any time. All commissions are contingent upon an active paid in full consultant or contractor subscription, where applicable. Simple reserves the right to terminate a relationship with a contractor as necessary.
        </p>

        <p class="mb-4 text-lg">
          5.2 The relationship established between Simple and all affiliates is that of independent contractors. Both parties shall conduct their respective businesses independently, bearing their own responsibilities and expenses, with no authority to incur obligations on behalf of the other unless explicitly stated herein. The term “consultant” is to be understood strictly as an independent contractor, not as a legal partner or affiliate.
        </p>

        <h2 class="text-2xl font-bold mb-2">
          6.0 Non-Compete Agreement
        </h2>

        <p class="mb-4 text-lg">
          6.1 Non-Compete Covenant: For the duration of your subscription and for a period of Three years thereafter, you agree not to engage in or assist others in engaging in any business activity that is in direct competition with the principal business of Readitfor.me LLC, Simple Academy and its subsidiary products.
        </p>

        <p class="mb-4 text-lg">
          6.2 Scope and Limitation: The non-compete covenant is limited to the geographical area and scope of business in which Readitfor.me LLC and its subsidiary products operates. This agreement does not prohibit you from engaging in lawful business activities that are unrelated to the areas in which Readitfor.me LLC competes or from continuing activities you were engaged with prior to joining Readitfor.me or Simple.
        </p>

        <p class="mb-4 text-lg">
          6.3 Remedies for Breach: Violation of this non-compete agreement will entitle Readitfor.me LLC and its subsidiary products to seek injunctive relief, damages, and legal costs.
        </p>

        <h2 class="text-2xl font-bold mb-2">
          7.0 Enforcement of Agreements
        </h2>
